...
urlpatterns = [
    ...
    url(r'^404/$', views.notFound, name='notFound'),  # URL for the authentication page
    ...
    url(r'^music/(?P<slug>[\w\-]+)/jpg/(?P<part>.*)/$', views.jpgShow, name='songHandler'),  # URL for the music page
